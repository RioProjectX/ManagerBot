...
def addsudo(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in DRAGONS:
        message.reply_text("Anggota ini sudah menjadi Bencana Naga")
        return ""

    if user_id in DEMONS:
        rt += "Meminta HA untuk mempromosikan Bencana Iblis ke Naga."
        data["supports"].remove(user_id)
        DEMONS.remove(user_id)

    if user_id in WOLVES:
        rt += "Meminta HA untuk mempromosikan Bencana Serigala ke Naga."
    ...
    update.effective_message.reply_text(
        rt
        + "\nBerhasil menyetel tingkat Bencana {} ke Naga!".format(
...
def addsupport(
    ...
    if user_id in DRAGONS:
        rt += "Meminta HA untuk menurunkan Naga ini menjadi Iblis"
    ...
    if user_id in WOLVES:
        rt += "Meminta HA untuk mempromosikan Bencana Serigala ini ke Iblis"
        data["whitelists"].remove(user_id)
        WOLVES.remove(user_id)
    ...
    update.effective_message.reply_text(
        rt + f"\n{user_member.first_name} ditambahkan sebagai Bencana Iblis!",
    )
...
def addwhitelist(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in DRAGONS:
        rt += "Anggota ini adalah Bencana Naga, diturunkan pangkatnya menjadi Serigala."
        data["sudos"].remove(user_id)
        DRAGONS.remove(user_id)

    if user_id in DEMONS:
        rt += "Pengguna ini sudah menjadi Demon Disaster, Demoting to Wolf."
        data["supports"].remove(user_id)
        DEMONS.remove(user_id)

    if user_id in WOLVES:
        message.reply_text("Pengguna ini sudah menjadi Bencana Serigala.")
        return ""
    ...
    update.effective_message.reply_text(
        rt + f"\nSuccessfully promoted {user_member.first_name} ke Bencana Serigala!",
    )
...
def addtiger(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in DRAGONS:
        rt += "Anggota ini adalah Bencana Naga, Turun pangkat menjadi Harimau."
        data["sudos"].remove(user_id)
        DRAGONS.remove(user_id)

    if user_id in DEMONS:
        rt += "Pengguna ini sudah menjadi Demon Disaster, Demoting to Tiger."
        data["supports"].remove(user_id)
        DEMONS.remove(user_id)

    if user_id in WOLVES:
        rt += "Pengguna ini sudah menjadi Bencana Serigala, Turunkan ke Harimau."
        data["whitelists"].remove(user_id)
        WOLVES.remove(user_id)

    if user_id in TIGERS:
        message.reply_text("Pengguna ini sudah menjadi Harimau.")
        return ""
    ...
    update.effective_message.reply_text(
        rt + f"\nSuccessfully promoted {user_member.first_name} ke Bencana Harimau!",
    )
...
def removesudo(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in DRAGONS:
        message.reply_text("Meminta HA untuk menurunkan pengguna ini menjadi Sipil")
        DRAGONS.remove(user_id)
        data["sudos"].remove(user_id)
        ...
        return log_message
    message.reply_text("Pengguna ini bukan Bencana Naga!")
    return ""
...
def removesupport(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in DEMONS:
        ...
        return log_message
    message.reply_text("Pengguna ini bukan Bencana tingkat Iblis!")
    return ""
...
def removewhitelist(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in WOLVES:
        message.reply_text("Demosi ke pengguna biasa")
        WOLVES.remove(user_id)
        data["whitelists"].remove(user_id)
...
def whitelistlist(update: Update, context: CallbackContext):
    reply = "<b>Bencana Serigala yang Diketahui 🐺:</b>\n"
...
def tigerlist(update: Update, context: CallbackContext):
    reply = "<b>Bencana Harimau yang Diketahui 🐯:</b>\n"
    m = update.effective_message.reply_text(
        "<code>Gathering intel..</code>",
        parse_mode=ParseMode.HTML,
    )
...
def supportlist(update: Update, context: CallbackContext):
    ...
    reply = "<b>Bencana Iblis yang Diketahui 👹:</b>\n"
...
def sudolist(update: Update, context: CallbackContext):
    ...
    reply = "<b>Bencana Naga yang Diketahui 🐉:</b>\n"
...
Visit @riogrousupport for more information.
"""
